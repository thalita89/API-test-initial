...
public class UserController {
	...
	@PostMapping
	public ResponseEntity<?> saveUser(@RequestBody @Valid UserDto userDto, UserValidation userValidation) throws JSONException, Exception, BusinessException {
	...
	@PutMapping("/{id}")
	@Transactional
	public ResponseEntity<?> updateUser(@PathVariable Long id, @RequestBody @Valid UserDto userDto, UserValidation userValidation) throws JSONException, BusinessException { // form define somente os tópicos que desejo atualizar
